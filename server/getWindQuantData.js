...
function getTime() {
	...
	let preDate = new Date(curDate.getTime() - 12 * 60 * 60 * 1000);
	let options = { year: 'numeric', month: '2-digit', day: '2-digit' };
	res = preDate.toLocaleTimeString('zh-CN', options).slice(0, 10).replace(/\//g, '-');
	return res;
}
...
//query string
const queryString =
	'indicators=S6274770,S6274772,S6274771,S6274773,S6274775,S6274778,S6274777,S6274776,S6274780,S6274782,S6274784,S6290834&';
//截止时间
